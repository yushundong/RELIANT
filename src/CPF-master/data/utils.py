...
def choose_path(conf):
    ...
    if conf['student'] == 'PLP' and conf['ptype'] == 'ind':
        output_dir = Path.cwd().joinpath('outputs', conf['dataset'], teacher_str + '_' + conf['student'],
                                         'cascade_random_' + str(conf['division_seed']) + '_' + str(conf['labelrate']) + '_ind', conf['metric'])
    elif conf['student'] == 'PLP' and conf['ptype'] == 'tra':
        output_dir = Path.cwd().joinpath('outputs', conf['dataset'], teacher_str + '_' + conf['student'],
                                         'cascade_random_' + str(conf['division_seed']) + '_' + str(conf['labelrate']) + '_tra', conf['metric'])
    else:
        output_dir = Path.cwd().joinpath('outputs', conf['dataset'], teacher_str + '_' + conf['student'],
                                         'cascade_random_' + str(conf['division_seed']), conf['metric'])
