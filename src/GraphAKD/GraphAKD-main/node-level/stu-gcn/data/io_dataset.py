...
from data.preprocess import eliminate_self_loops as eliminate_self_loops_adj
from data.preprocess import largest_connected_components
...
class SparseGraph:
    ...
    def __init__(self, adj_matrix, attr_matrix=None, labels=None,
                 node_names=None, attr_names=None, class_names=None, metadata=None, sens=None):
    ...
    def unpack(self):
        ...
        return self.adj_matrix, self.attr_matrix, self.labels, self.sens
...
def load_npz_to_sparse_graph(file_name):
    ...
    return SparseGraph(adj_matrix, attr_matrix, labels, node_names, attr_names, class_names, metadata, sens)
